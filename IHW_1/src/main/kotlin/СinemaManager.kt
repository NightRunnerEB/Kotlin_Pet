...
class CinemaManager( val cinemaHall: CinemaHall, movies: MutableList<Movie>, sessions: MutableList<Session>, var tickets: MutableList<Ticket>) {
    ...
    var sessions: MutableList<Session> = mutableListOf(
        Session(movies[0], LocalDateTime(2023, 12, 25, 10, 30), LocalDateTime(2023, 12, 25, 13, 20), Array(cinemaHall.totalSeats) { true }),
        Session(movies[1], LocalDateTime(2023, 12, 25, 13, 40), LocalDateTime(2023, 12, 25, 15, 35), Array(cinemaHall.totalSeats) { true }),
        Session(movies[2], LocalDateTime(2023, 12, 25, 15, 55), LocalDateTime(2023, 12, 25, 17, 20), Array(cinemaHall.totalSeats) { true }),
        )
